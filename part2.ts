...
*/
var my_friends:string[] = ['Nadeem','Shafqat','Mohsin','Gulfam','Shahid'];
...
*/
var transportation:string[] = ['Bike','Car','MG','Mercedes','Qatar Airlins'];
...
*/
// 
type item_type = "book" | "phone" | "pen" | "laptop" | "headphones";
